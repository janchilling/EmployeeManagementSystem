...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<div>
						<a href="<%=request.getContextPath()%>/employeeDetails?username=<%=empDetails.getUsername()%>"> View Your Account Details</a>
					</div>
						...
						<ul class="form-section page-section">
							<li id="cid_19" class="form-input-wide" data-type="control_head">
								<div class="form-header-group  header-default">
									<div class="header-text httal htvam">
										...
										<div id="subHeader_19" class="form-subHeader">Account
											Details.</div>
									</div>
								</div>
							</li>
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="text" id="id" name="id" data-type="input-textbox"
										...
										size="20" value="<c:out value="${emp.id}" />" placeholder=" "
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="text" id="name" name="name"
										...
										class="form-textbox validate[required]" data-defaultvalue=""
										size="60" value="<c:out value="${emp.name}" />" placeholder=" "
							...
							<li class="form-line jf-required" data-type="control_dropdown"
								...
								<div id="cid_22" class="form-input jf-required">
									<select class="form-dropdown validate[required]" id="gender" disabled
										name="gender" style="width: 150px" data-component="dropdown"
										required="">
										<option value="<c:out value="${emp.gender}" />"><%=empDetails.getGender()%></option>
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="text" id="phone" name="phone"
										data-type="input-textbox"
										class="form-textbox validate[required]" data-defaultvalue=""
										size="20" value="<c:out value="${emp.phone}" />" placeholder=" "
										readonly data-component="textbox" aria-labelledby="label_4" />
								</div></li>
								...
								<div id="cid_9" class="form-input jf-required">
									<div data-wrapper-react="true">
										<span class="form-sub-label-container"
											style="vertical-align: top"> <select name="DOBDay" disabled
											id="DOBDay" class="form-dropdown validate[required]"
											data-component="birthdate-day"
											aria-labelledby="label_9 sublabel_9_day"
											value="<c:out value="${emp.dobDay}" />">
												<option value="<c:out value="${emp.dobDay}" />"><c:out value="${emp.dobDay}" /></option>
											...
											style="vertical-align: top"> <select name="DOBMonth" disabled
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="text" id="username" name="username"
										...
										class="form-textbox validate[required]" data-defaultvalue=""
										size="20" value="<c:out value="${emp.dobDay}" />"
							...
							<li class="form-line jf-required" data-type="control_dropdown"
								...
								<div id="cid_22" class="form-input jf-required">
									<select class="form-dropdown validate[required]"
										id="department" name="position" style="width: 150px" disabled
							...
							<li class="form-line jf-required" data-type="control_dropdown"
								id="id_22"><label
								class="form-label form-label-left form-label-auto" id="label_22" disabled
